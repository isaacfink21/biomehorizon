...
```
paramList <- prepanel(otudata = otusample, metadata = metadatasample, subj = "subject_1", thresh_prevalence = 90, thresh_abundance = 1.5)
```
...
```
paramList <- prepanel(otudata = otusample, metadata = metadatasample, subj = "subject_1", otulist = c("otu_1243", "otu_6821", "otu_2378", "otu_7737", "otu_1530", "otu_8547", "otu_6570", "otu_2552"))
```
